...
module.exports = {
    logUserRegistration: (user, outcome) => logEvent({ type: 'USER_REGISTRATION', user, outcome }),
    logUserLogin: (user, outcome) => logEvent({ type: 'USER_LOGIN', user, outcome }),
    ...
    logSetRoomLights: (user, room, state) => logEvent({ type: 'SET_ROOM_LIGHTS', user, room, state }),
    logGetOneLight: (user, light) => logEvent({ type: 'GET_ONE_LIGHT', user, light }),
    logSetOneLight: (user, light, state) => logEvent({ type: 'SET_ONE_LIGHT', user, light, state }),
